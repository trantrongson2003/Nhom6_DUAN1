 ...
 * @author kunrl
 */
public class SanPhamChiTietPanel extends javax.swing.JPanel {
        ...
        if (count % 5 == 0) {
            for (int i = n; i < m; i++) {
                dtm1.addRow(new Object[]{sp.get(i).getMa(),
                    ...
                    sp.get(i).getNhaSanXuat(), sp.get(i).getChatLieuDeGiay(),
                    sp.get(i).getHang(),
...
//        lblTrang.setText(tranghientai + 1 + "/" + tongsoTrang);
    ...
    private void initComponents() {
        ...
        cbbCLDG = new javax.swing.JComboBox<com.mycompany.DomainModels.ChatLieuDeGiay>();
        ...
        jLabel8.setText("Chất liệu đế giày");
        ...
        cbbCLDG.setModel(new javax.swing.DefaultComboBoxModel<>());
        ...
        btnAddsanpham.setBackground(new java.awt.Color(255, 255, 0));
        btnAddsanpham.setForeground(new java.awt.Color(255, 255, 0));
        btnAddsanpham.setIcon(new javax.swing.ImageIcon(getClass().getResource("/add.png"))); // NOI18N
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(btnAddsanpham, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(56, 56, 56)
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(btnAddloai, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(cbbCLDG, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 184, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                ...
                                .addComponent(cbbCLDG, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(btnAddsanpham, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))))
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
...
//        txtBarcode.setText("");
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        ChatLieuDeGiay ncc = (ChatLieuDeGiay) cbbCLDG.getSelectedItem();
...
//                ctsp.setBarcode(txtBarcode.getText());
    ...
    private void cbSanPhamActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbSanPhamActionPerformed
        // TODO add your handling code here:
//        SanPham sp = getCbSanPham(cbSanPham.getSelectedItem());
        SanPham sp = spService.getAllChucVu().get(cbSanPham.getSelectedIndex());
        txtMa.setText(sp.getMa());
        txtTen.setText(sp.getTen());
        System.out.println(cbSanPham.getSelectedIndex());
    ...
    private javax.swing.JComboBox<com.mycompany.DomainModels.ChatLieuDeGiay> cbbCLDG;
...
//    public SanPham getCbSanPham(Object sp) {
//        for (int i = 0; i < spService.getAllChucVu().size(); i++) {
//            SanPham item = spService.getAllChucVu().get(i);
//            if (item.equals(sp)) {
//                return item;
//            }
//        }
...
//    }
    ...
    public void loadCCBSanPham() {
        for (SanPham sp : spService.getAllChucVu()) {
    ...
    public void loadCBBCLGD() {

        for (ChatLieuDeGiay cldg : nhaCungCapService.GetALLCLDG()) {
            cbbCLDG.addItem(cldg);
        }
...
//        txtBarcode.setText(tblSP.getValueAt(row, 12).toString());
        ...
        Integer slncc = cbbCLDG.getItemCount();
        for (int i = 0; i < slncc; i++) {
            ChatLieuDeGiay cungCap = cbbCLDG.getItemAt(i);
            if (cungCap.getTen().equals((String) ncc)) {
                cbbCLDG.setSelectedIndex(i);
            }
        }
