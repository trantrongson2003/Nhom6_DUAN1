...
public class SanPhamForm extends javax.swing.JFrame {
    ...
    private SanPhamService sanphamser =new SanPhamServiceImp();
    ...
    private SanPham getForm() {
        ...
        SanPham sp =new SanPham(id, ma, ten,new Date(), new Date(),null);
        return sp;
    }
    ...
    private void initComponents() {
        ...
        tbl_DongSP.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Mã sản phẩm", "Tên sản phẩm", "Ngày tạo", "Ngày sửa"
            }
        ));
